    ...
    <div className="pro">
      ...
      <div className="text">
        ...
        <div className="textbottom">
          ...
          <div className="links">
            <div className="demo_link"><a href={props.link} target={props.target}>Demo<div className="icon"><MdKeyboardArrowRight/></div></a></div>
            <div className="code_link"><a href={props.code} target={props.target}><div className="code">Code</div><div className="icon"><MdKeyboardArrowRight/></div></a></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <section id='projects'>      
        <div className="container projects__container">
          ...
          <div className="projects">
            ...
            <Pro img={clock} name="Clock" desc="Clock app that besides current time let's user set an alarm and choose a sound and a message. The app also allows user to set a timer and a stopwatch. It also offers light and dark mode." lang={clock_items} link={process.env.PUBLIC_URL + "/clock"}  code="https://github.com/lukmikas/clock"/>
            <Pro img={gomoku} name="Gomoku" desc="Gomoku, also known as Five in a Row, is a two-player board game similar to tic-tac-toe but played on a 15x15 grid. The objective of the game is to be the first player to place five stones in a row horizontally, vertically, or diagonally." lang={gomoku_items} link={process.env.PUBLIC_URL + "/gomoku"} code="https://github.com/lukmikas/gomoku"/>
          </div>
        </div>
      </section>
  )
